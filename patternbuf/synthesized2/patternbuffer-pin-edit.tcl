...
# or
editPin -side Left -pinWidth 0.28 -pinDepth 1.12 -fixOverlap 1 -layer 2 -spreadType start -spacing 25 -start 0.0 0.28 -pin {{bufp_in[0]} {bufp_in[1]} {bufp_in[2]} clk {field_in_in[0]} {field_in_in[1]} {field_in_in[2]} {field_in_in[3]} {field_in_in[4]} {field_in_in[5]} {field_in_in[6]} {field_in_in[7]} field_write_in {fieldp_in[0]} {fieldp_in[1]} {fieldp_in[2]} {fieldp_in[3]} {fieldp_in[4]} {fieldwp_in[0]} {fieldwp_in[1]} {fieldwp_in[2]} {fieldwp_in[3]} {fieldwp_in[4]} pwm reset {saddr[0]} {saddr[1]} {saddr[2]} sclk sin ssel}
